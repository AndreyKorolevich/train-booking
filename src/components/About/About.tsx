  ...
  return (
    <div className='card'>
      <div className='card-body'>
        ...
        людей заказывают жд билеты через интернет. Сегодня можно заказать железнодорожные билеты онлайн всего
        в 2 клика, но стоит ли это делать? Мы расскажем о преимуществах заказа через интернет.
        <span>
